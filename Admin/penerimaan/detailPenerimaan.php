...
$dataAtas = mysqli_query($sambungin,"SELECT * FROM tbpenerimaan left join tblogin on tbpenerimaan.id_login = tblogin.id_login where kode_terima = '$kode_terima'");
					...
					<div class="row">
						<div class="col-md-5">
							...
							<div>
								...
								<div class="pull-right"><?php echo $x['nama_admin'] ?> </div>
								<div class="clearfix"></div>
							</div>
						</div>
					</div>
