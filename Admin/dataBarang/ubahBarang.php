...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $lokasi = $_POST['lokasi'];
		...
		$simpan = mysqli_query($sambungin,"UPDATE tbbarang SET nama_barang='$nama_barang', kode_kategori='$kode_kategori', spesifikasi = '$spesifikasi', stok = '$stok', lokasi = '$lokasi' where kode_barang = '$kode_barang'");
